...
* Whitelist specific repositories against specific hooks (See [Whitelists](https://github.com/krishicks/git-hooks-core#whitelists))
...
```
git clone https://github.com/krishicks/git-hooks-core $HOME/workspace/git-hooks-core
```
